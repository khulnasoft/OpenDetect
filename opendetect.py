...
# Execute: python3 opendetect.py <protocol> --host <IP> [--port <PORT>] [--workdir <PATH>] [-v] [-b] [-u <username] [-U usernamesList] [-P passwordsList] [--protohelp] [--notuse <Ex: nmap,gobuster,dirsearch>]  
...
def check_args(args=None):
    ...
    parser.add_argument('--workdir', default=expanduser("~")+'/.opendetect/',
                        help='Working directory (Default: '+expanduser("~")+'/.opendetect/)')
